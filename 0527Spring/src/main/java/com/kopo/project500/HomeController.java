...
public class HomeController {
	...
	public String listMethod(Locale locale, Model model) {
		...
		String htmlString = db.selectDataTableTag(new Student());
...
//		db.updateData(new Student(idx, sName, middleScore, finalScore, now));
	...
	public String createTable(Locale locale, Model model) {
		DBCommon<OfficePeople> db = new DBCommon<OfficePeople>("c:/tomcat/p500.db", "p1");
		db.createTable(new OfficePeople());
//		UserDB db = new UserDB();
//		db.createTable();
