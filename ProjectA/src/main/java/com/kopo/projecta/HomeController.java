...
public class HomeController {
	...
	public String list(Locale locale, Model model) {
		UserDB userDB = new UserDB();
		String resultString = userDB.selectData();
	...
	public String updateMethod(Locale locale, Model model, 
		...
		UserDB userDB = new UserDB();
		People selectPeople = userDB.detailsData(idx);
	...
	public String updateAction(Locale locale, Model model
		...
		UserDB userDB = new UserDB();
		userDB.updateData(idx, id, name, birthday, address);

		model.addAttribute("m1", "회원정보가 수정되었습니다.");
		return "message";
	}
